package dev.slne.surf.essentialsold.commands;

import com.mojang.brigadier.tree.CommandNode;
import dev.jorel.commandapi.CommandAPI;
import dev.slne.surf.essentialsold.commands.cheat.*;
import dev.slne.surf.essentialsold.commands.cheat.gui.GuiCommands;
import dev.slne.surf.essentialsold.commands.general.*;
import dev.slne.surf.essentialsold.commands.general.other.ActionbarBroadcastCommand;
import dev.slne.surf.essentialsold.commands.general.other.TimerCommand;
import dev.slne.surf.essentialsold.commands.general.other.TitlebroadcastCommand;
import dev.slne.surf.essentialsold.commands.general.other.help.HelpCommand;
import dev.slne.surf.essentialsold.commands.general.other.poll.PollCommand;
import dev.slne.surf.essentialsold.commands.general.other.poll.VoteCommand;
import dev.slne.surf.essentialsold.commands.general.other.world.WorldCommand;
import dev.slne.surf.essentialsold.commands.minecraft.*;
import dev.slne.surf.essentialsold.commands.tp.*;
