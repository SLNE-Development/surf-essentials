...
import dev.slne.surf.essentialsold.commands.minecraft.WeatherCommand;
import dev.slne.surf.essentialsold.listener.listeners.CommandRegisterListener;
import dev.slne.surf.essentialsold.utils.arguments.*;
...
public abstract class EssentialsCommand extends CommandTree {
     ...
     * <br>
     * When the argument is parsed, it returns a {@link dev.slne.surf.essentialsold.commands.general.other.poll.Poll} object.
     *
     * @param nodeName the name of the argument
