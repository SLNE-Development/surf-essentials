...
object EssentialsPermissionRegistry : PermissionRegistry() {
    ...
    val GAME_MODE_BASE = create("$PREFIX.gameMode")
    val GAME_MODE_WILDCARD = create("$PREFIX.gameMode.*")
    ...
    val SUICIDE_COMMAND_OTHERS = create("$PREFIX.suicide.command.others")
    ...
    val KILL_COMMAND_MANY = create("$PREFIX.kill.command.others")
    ...
    val STOP_COMMAND = create("$PREFIX.stop.command")
