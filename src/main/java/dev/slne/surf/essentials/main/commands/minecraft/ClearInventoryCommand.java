...
@PermissionTag(name = Permissions.CLEAR_SELF_PERMISSION, desc = "Allows you to clear your inventory")
@PermissionTag(name = Permissions.CLEAR_OTHER_PERMISSION, desc = "Allows you to clear others inventories")
