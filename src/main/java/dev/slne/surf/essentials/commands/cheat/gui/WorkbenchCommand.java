...
public class WorkbenchCommand extends BrigadierCommand {
    @Override
    public String[] names() {
        return new String[]{"workbench", "crafting", "craftingtable"};
    }

    @Override
    public String usage() {
        return "/workbench [<targets>]";
    }

    @Override
    public String description() {
        return "Opens the workbench gui for the targets";
    }
    ...
    public void literal(LiteralArgumentBuilder<CommandSourceStack> literal){
        ...
        literal.then(Commands.argument("targets", EntityArgument.players())
                .requires(EssentialsUtil.checkPermissions(Permissions.WORKBENCH_OTHER_PERMISSION))
